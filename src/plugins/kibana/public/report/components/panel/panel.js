define(function (require) {
  ...
  require('ui/modules')
  .get('app/report')
  .directive('reportPanel', function (savedVisualizations, savedSearches, Notifier, Private, $injector) {
    var _ = require('lodash');
    var loadPanel = Private(require('plugins/kibana/report/components/panel/lib/load_panel'));
    ...
    return {
      ...
      link: function ($scope, $el) {
        ...
        var print_report = $scope.print_report;
        $scope.$el = $el;
        ...
        $scope.$watch('id', function () {
          ...
          .then(function (panelConfig) {
            ...
            $scope.printing_report = print_report;
            console.log("Printing report is ");
            console.log($scope.printing_report);
