define(function (require) {
  ...
  /**
   * User is not allowed to access saved object
   * @param {String} field - the fields which contains the conflict
   */
  errors.SavedObjectNotAllowed = function SavedObjectNotAllowed(operation, type, id) {
    this.savedObjectType = type;
    this.savedObjectId = id;
    var idMsg = id ? ' (id: ' + id + ')' : '';
    KbnError.call(this,
      "Operation " + operation + " for " + type + idMsg + ' is not allowed',
      errors.SavedObjectNotAllowed);
  };
  _.class(errors.SavedObjectNotAllowed).inherits(KbnError);
