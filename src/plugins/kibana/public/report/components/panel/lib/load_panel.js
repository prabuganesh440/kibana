define(function (require) {
  ...
  return function loadPanelFunction(Private) { // Inject services here
    return function (panel, $scope) { // Function parameters here
      var panelTypes = {
        visualization: Private(require('plugins/kibana/report/components/panel/lib/visualization')),
        search: Private(require('plugins/kibana/report/components/panel/lib/search'))
      };
