define(function (require) {
  ...
  module.service('savedSearches', function (Promise, config, kbnIndex, es, createNotifier, SavedSearch, kbnUrl, $http) {
    ...
    this.delete = function (ids) {
      ...
      return Promise.map(ids, function (id) {
        return (new SavedSearch(id)).delete().then( function() {
            lup.logUserOperation($http, 'DELETE','search', id);
        });
      });
    };
