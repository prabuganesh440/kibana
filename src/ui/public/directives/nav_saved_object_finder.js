// JS for displaying the navigation bar for dashboard names under View option
define(function (require) {
  ...
  module.directive('navSavedObjectFinder', function ($location, $injector, kbnUrl, Private) {
    ...
    return {
      ...
      template: require('ui/partials/nav_saved_object_finder.html'),
      controllerAs: 'finder',
