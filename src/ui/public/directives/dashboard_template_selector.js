define(function (require) {
  ...
  module.directive('dashboardTemplateSelector', function ($location, $injector, kbnUrl, Private) {
    ...
    return {
      ...
      template: require('ui/partials/dashboard_template_selector.html'),
      controllerAs: 'finder',
      controller: function ($scope, $element, $timeout) {
        ...
        self.onChoose = function (hit, $event) {
          if ($scope.userOnChoose) {
            $scope.userOnChoose(hit, $scope.ipaddress, $event);
          }
